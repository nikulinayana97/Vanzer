$(document).ready(function() {
		$(document).delegate('.header__menu', 'click', function(event){
			$(this).addClass('oppenned');
			event.stopPropagation();
		})
		$(document).delegate('body', 'click', function(event) {
			$('.header__menu').removeClass('oppenned');
		})
...
if (tabBg.css('display') == 'block') {
	document.getElementByClass('services').style.background = 'url(../img/about-1.jpg)';
}
